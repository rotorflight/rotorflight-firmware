...
extern volatile uint8_t  usb_rx_activity;
extern volatile uint8_t  usb_tx_activity;
extern volatile uint8_t  usb_dtr_active;
extern volatile uint8_t  usb_line_coding_set;
extern volatile uint8_t  usb_out_ep_armed;
extern volatile uint8_t  usb_config_event_seen;
