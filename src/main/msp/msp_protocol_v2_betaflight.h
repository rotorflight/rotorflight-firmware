...
#define MSP2_GET_ESC_INFO                   0x3008
#define MSP2_GET_ESC_NAME                   0x3009
#define MSP2_GET_ESC_WRITE_STATUS           0x300A
#define MSP2_GET_ESC_PARAM_DATA             0x300B
#define MSP2_SET_ESC_PARAM_BEGIN            0x300C
#define MSP2_SET_ESC_PARAM_DATA             0x300D
#define MSP2_SET_ESC_PARAM_COMMIT           0x300E
#define MSP2_GET_ESC_DETAILS                0x300F
