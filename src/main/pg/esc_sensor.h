...
typedef struct {
    ...
    uint16_t    current_correction_factor;        // Correction factor for current over/under reporting in %
    uint16_t    consumption_correction_factor;    // Correction factor for consumption over/under reporting in %
} escSensorConfig_t;
