...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE("rate_normalization", "%d",              currentPidProfile->rate_normalization);
        ...
        BLACKBOX_PRINT_HEADER_LINE("gov_max_headspeed", "%d",               governorConfig()->gov_max_headspeed);
        ...
        BLACKBOX_PRINT_HEADER_LINE("gov_gain", "%d",                        governorConfig()->gov_gain);
        BLACKBOX_PRINT_HEADER_LINE("gov_p_gain", "%d",                      governorConfig()->gov_p_gain);
        BLACKBOX_PRINT_HEADER_LINE("gov_i_gain", "%d",                      governorConfig()->gov_i_gain);
        BLACKBOX_PRINT_HEADER_LINE("gov_d_gain", "%d",                      governorConfig()->gov_d_gain);
        BLACKBOX_PRINT_HEADER_LINE("gov_f_gain", "%d",                      governorConfig()->gov_f_gain);
        BLACKBOX_PRINT_HEADER_LINE("gov_cyclic_ff_weight", "%d",            governorConfig()->gov_cyclic_ff_weight);
        BLACKBOX_PRINT_HEADER_LINE("gov_collective_ff_weight", "%d",        governorConfig()->gov_collective_ff_weight);
        ...
        BLACKBOX_PRINT_HEADER_LINE("gov_tta_gain", "%d",                    governorConfig()->gov_tta_gain);
        BLACKBOX_PRINT_HEADER_LINE("gov_tta_limit", "%d",                   governorConfig()->gov_tta_limit);
