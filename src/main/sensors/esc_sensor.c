...
{
    if (hw4CurrentValue > hw4CurrentFilter || hw4CurrentValue == 0)
        hw4CurrentFilter += (hw4CurrentValue - hw4CurrentFilter) * hw4CurrentFast;
    else
        hw4CurrentFilter += (hw4CurrentValue - hw4CurrentFilter) * hw4CurrentSlow;
