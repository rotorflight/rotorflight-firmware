...
static inline int scaleRange(int x, int srcFrom, int srcTo, int dstFrom, int dstTo)
{
    const int a = (dstTo - dstFrom) * (x - srcFrom);
    const int b = srcTo - srcFrom;
    return (a / b) + dstFrom;
}

static inline float scaleRangef(float x, float srcFrom, float srcTo, float dstFrom, float dstTo)
{
    const float a = (dstTo - dstFrom) * (x - srcFrom);
    const float b = srcTo - srcFrom;
    return (a / b) + dstFrom;
}
