...
static const char * const lookupTableDebugAxis[] = {
...
const lookupTableEntry_t lookupTables[] = {
    ...
    LOOKUP_TABLE_ENTRY(lookupTableDebugAxis),
#ifdef USE_GPS
...
// PG_BLACKBOX_CONFIG
    ...
    { "blackbox_log_control",       VAR_UINT32 | MASTER_VALUE | MODE_BITSET, .config.bitpos = FLIGHT_LOG_FIELD_SELECT_CONTROL, PG_BLACKBOX_CONFIG, offsetof(blackboxConfig_t, fields) },
...
#endif
    { "blackbox_log_debug",         VAR_UINT32 | MASTER_VALUE | MODE_BITSET, .config.bitpos = FLIGHT_LOG_FIELD_SELECT_DEBUG, PG_BLACKBOX_CONFIG, offsetof(blackboxConfig_t, fields) },
#endif
...
// PG_GOVERNOR_CONFIG
    ...
    { "gov_headspeed",              VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 10000 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_headspeed) },
...
// PG_PID_PROFILE
    ...
    { "pitch_e_cutoff",             VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, error_cutoff[PID_PITCH]) },
    { "pitch_bandwidth",            VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, gyro_cutoff[PID_PITCH]) },
    ...
    { "roll_e_cutoff",              VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, error_cutoff[PID_ROLL]) },
    { "roll_bandwidth",             VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, gyro_cutoff[PID_ROLL]) },
    ...
    { "yaw_e_cutoff",               VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, error_cutoff[PID_YAW]) },
    { "yaw_bandwidth",              VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, gyro_cutoff[PID_YAW]) },
...
// PG_SYSTEM_CONFIG
    ...
    { PARAM_NAME_DEBUG_AXIS,        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_DEBUG_AXIS }, PG_SYSTEM_CONFIG, offsetof(systemConfig_t, debug_axis) },
#ifdef USE_OVERCLOCK
