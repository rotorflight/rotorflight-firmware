...
// PG_TELEMETRY_CONFIG
    ...
    { "telemetry_disabled_adjustment",      VAR_UINT32  | MASTER_VALUE | MODE_BITSET, .config.bitpos = LOG2(SENSOR_ADJUSTMENT),      PG_TELEMETRY_CONFIG, offsetof(telemetryConfig_t, disabledSensors)},
#else
