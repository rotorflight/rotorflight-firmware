...
// PG_DISPLAY_PORT_MSP_CONFIG
    ...
    { "esc_sensor_hw4_valid_current_threshold",     VAR_UINT8   | MASTER_VALUE, .config.minmaxUnsigned = { 0, 500 }, PG_ESC_SENSOR_CONFIG, offsetof(escSensorConfig_t, hw4_valid_current_threshold) },
#endif
