...
// PG_MIXER_CONFIG
    ...
    { "collective_scale_pos",       VAR_UINT8  | MASTER_VALUE,  .config.minmax = { 0, 100 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, collective_scale_pos) },
    { "collective_scale_neg",       VAR_UINT8  | MASTER_VALUE,  .config.minmax = { 0, 100 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, collective_scale_neg) },
