...
static const char * const lookupTableEscSensorProtocol[] = {
    "OFF", "BLHELI32", "HOBBYWINGV4", "HOBBYWINGV5", "SCORPION", "KONTRONIK", "OMPHOBBY", "ZTW", "APD", "RECORD",
};
#endif
...
// PG_GYRO_CONFIG
    ...
    { PARAM_NAME_DYN_NOTCH_Q,           VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 100, 1000 }, PG_DYN_NOTCH_CONFIG, offsetof(dynNotchConfig_t, dyn_notch_q) },
...
// PG_MIXER_CONFIG
    ...
    { "tail_center_trim",           VAR_INT8   | MASTER_VALUE,  .config.minmax = { -125, 125 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, tail_center_trim) },
    ...
    { "collective_tta_precomp",     VAR_UINT8  | MASTER_VALUE,  .config.minmaxUnsigned = { 0, 250 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, coll_tta_precomp) },
