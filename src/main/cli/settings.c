...
// PG_BATTERY_CONFIG
    ...
    { "bat_capacity",               VAR_UINT16 | MASTER_VALUE | MODE_ARRAY, .config.array.length = BATTERY_PROFILE_MAX, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, batteryCapacity) },
    { "bat_profile",                   VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, BATTERY_PROFILE_MAX - 1 }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, batteryProfile) },
