...
typedef enum {
    ...
    ARMING_DISABLED_REBOOT_REQUIRED = (1 << 20),
    ARMING_DISABLED_DSHOT_BITBANG   = (1 << 21),
    ARMING_DISABLED_ACC_CALIBRATION = (1 << 22),
    ARMING_DISABLED_MOTOR_PROTOCOL  = (1 << 23),
    ARMING_DISABLED_OVERRIDE        = (1 << 24),
