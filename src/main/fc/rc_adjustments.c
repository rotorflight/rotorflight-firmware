...
static const adjustmentConfig_t adjustmentConfigs[ADJUSTMENT_FUNCTION_COUNT] =
{
    ...
    ADJ_CONFIG(GOV_BASE_THROTTLE,       GOV,   0, 100),
...
static int getAdjustmentValue(adjustmentFunc_e adjFunc)
{
    ...
    switch (adjFunc) {
        ...
        case ADJUSTMENT_GOV_AUTO_THROTTLE:
            ...
            break;
        case ADJUSTMENT_GOV_BASE_THROTTLE:
            value = currentPidProfile->governor.base_throttle;
            break;
...
static void setAdjustmentValue(adjustmentFunc_e adjFunc, int value)
{
    switch (adjFunc) {
        ...
        case ADJUSTMENT_GOV_AUTO_THROTTLE:
            ...
            break;
        case ADJUSTMENT_GOV_BASE_THROTTLE:
            currentPidProfile->governor.base_throttle = value;
            break;
        case ADJUSTMENT_FUNCTION_COUNT:
            break;
    }
