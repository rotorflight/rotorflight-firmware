...
#elif defined(CH32H4)
// CH32H4: IOCFG macros are defined in platform.h
// (IO_CONFIG, IOCFG_OUT_PP, IOCFG_AF_PP, etc. are already provided)
...
#if defined(STM32F7) || defined(STM32H7) || defined(STM32G4) || defined(CH32H4)
